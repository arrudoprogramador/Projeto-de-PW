...
if (isset($_POST['nome'], $_POST['email'], $_POST['senha'], $_POST['cpf'], $_POST['data_nasc'], $_POST['tel'], $_POST['senha_confirm'])) {
    $nome = $_POST['nome'];
    $email = $_POST['email'];
    $senha = $_POST['senha'];
...
<div class="main-login">
    ...
    <form action="validaCadastro.php" method="post" id="cadastroForm">
        ...
        <div class="textfield-row">
            ...
            <div class="textfield">
                ...
                <input type="text" class="form-control" id="tel" name="tel" placeholder="Digite telefone de contato" required>
