...
.left-login h1 {
    ...
    <div class="container">
        <div class="content">
            ...
            <p>A Pegassus foi fundada em 2024 por dois jovens empreendedores apaixonados por esportes e movidos pelo desejo de promover um estilo de vida saudável para todos. Desde o início, a missão da empresa tem sido oferecer roupas e artigos esportivos de alta qualidade, ajudando os clientes a alcançarem seus objetivos através do esporte e de práticas saudáveis.</p>

            <h2>O que nos move</h2>
            <p>Na Pegassus, acreditamos que o esporte é uma das formas mais poderosas de transformar vidas. Seja você um atleta profissional ou alguém que busca melhorar a qualidade de vida, estamos comprometidos em fornecer os melhores produtos para que cada experiência esportiva seja a melhor possível. Nossa equipe trabalha incansavelmente para garantir que você tenha acesso aos materiais mais adequados para suas atividades.</p>
